...
package com.way.capture.widget.springindicator;
...
public class SpringIndicator extends FrameLayout {
    ...
    private void initAttrs(AttributeSet attrs){
        ...
        selectedTextColorId = android.R.color.white;
        indicatorColorId = R.color.colorAccent;
        textSize = sp2px(getContext(), 12);
        radiusMax = dp2px(getContext(), 12);
        radiusMin = dp2px(getContext(), 4);
