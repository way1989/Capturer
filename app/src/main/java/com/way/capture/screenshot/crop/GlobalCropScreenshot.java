...
class SaveImageInBackgroundTask extends AsyncTask<SaveImageInBackgroundData, Void, SaveImageInBackgroundData> {
    ...
    SaveImageInBackgroundTask(Context context, SaveImageInBackgroundData data, NotificationManager nManager, int nId) {
        ...
        mScreenshotDir = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES),
        ...
        mNotificationBuilder = new Notification.Builder(context)
                .setTicker(r.getString(R.string.screenshot_saving_ticker) + (mTickerAddSpace ? " " : ""))
        ...
        mNotificationStyle = new BigPictureStyle().bigPicture(preview);
    ...
    protected SaveImageInBackgroundData doInBackground(SaveImageInBackgroundData... params) {
        ...
        try {
            ...
            mNotificationBuilder.addAction(R.drawable.ic_menu_share, r.getString(R.string.share),
                    PendingIntent.getActivity(context, 0, chooserIntent, PendingIntent.FLAG_CANCEL_CURRENT));

            Intent deleteIntent = new Intent();
            deleteIntent.setClass(context, com.way.capture.screenshot.DeleteScreenshot.class);
            deleteIntent.putExtra(com.way.capture.screenshot.DeleteScreenshot.SCREENSHOT_URI, uri.toString());

            mNotificationBuilder.addAction(R.drawable.ic_menu_delete, r.getString(R.string.screenshot_delete_action),
    ...
    protected void onPostExecute(SaveImageInBackgroundData params) {
        ...
        if (params.result > 0) {
            ...
            GlobalCropScreenshot.notifyScreenshotError(params.context, mNotificationManager);
        } else {
            ...
            mNotificationBuilder.setContentTitle(r.getString(R.string.screenshot_saved_title))
                    .setContentText(r.getString(R.string.screenshot_saved_text))
                    .setContentIntent(PendingIntent.getActivity(params.context, 0, launchIntent, 0)).setWhen(now)
            ...
            mPublicNotificationBuilder.setContentTitle(r.getString(R.string.screenshot_saved_title))
                    .setContentText(r.getString(R.string.screenshot_saved_text))
                    .setContentIntent(PendingIntent.getActivity(params.context, 0, launchIntent, 0)).setWhen(now)
                    .setAutoCancel(true).setColor(r.getColor(R.color.system_notification_accent_color));
 ...
 */
class GlobalCropScreenshot {
    protected static final int SCREENSHOT_NOTIFICATION_ID = 789;
    private static final String TAG = "GlobalCropScreenshot";
     ...
     */
    public GlobalCropScreenshot(Context context) {
        Resources r = context.getResources();
        mContext = context;
    ...
    static void notifyScreenshotError(Context context, NotificationManager nManager) {
        ...
        Notification.Builder b = new Notification.Builder(context)
                ...
                .setVisibility(Notification.VISIBILITY_PUBLIC) // ok to show
                // outside
                // lockscreen
    ...
    private void saveScreenshotInWorkerThread(Bitmap bitmap, Runnable finisher) {
        ...
        mSaveInBgTask = new SaveImageInBackgroundTask(mContext, data, mNotificationManager, SCREENSHOT_NOTIFICATION_ID)
                .execute(data);
    }
     ...
     */
    void takeScreenshot(Bitmap bitmap, Runnable finisher, boolean isShowAnim) {
...
//        }
    ...
    private ValueAnimator createScreenshotDropOutAnimation(int w, int h, boolean isFullScreen) {
        ValueAnimator anim = ValueAnimator.ofFloat(0f, 1f);
        ...
        if (isFullScreen) {
            // There is no status bar/nav bar, so just fade the screenshot away
            // in place
