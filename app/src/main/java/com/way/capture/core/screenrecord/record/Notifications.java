...
package com.way.capture.core.screenrecord.record;
...
public class Notifications extends ContextWrapper {
    public static final String ACTION_STOP = "com.way.capturer.action.STOP";
    ...
    public void recording(long timeMs) {
        ...
        Notification notification = getBuilder()
                .setContentText(getString(R.string.video_length,
                        DateUtils.formatElapsedTime(timeMs / 1000))).build();
