...
public class TrimTimeBar extends TimeBar {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (!mShowTimes && !mShowScrubber) {
            Log.d("guan05181", "TrimTimeBar.java onLayout");
            ...
            Log.d("guan05181", "TrimTimeBar.java getPaddingLeft()=" + getPaddingLeft() + ",margin=" + margin + ",progressY=" + progressY);
            mProgressBar.set(
                    /*getPaddingLeft() + margin */getPaddingLeft() * 3, progressY,//change for BUG guanjw 20150518
                    w - getPaddingRight() * 3/* - margin*/, progressY + 4);
        }
        update();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mShowScrubber) {
            Log.d("guan0521", "TrimTimeBar.java mScrubberLeft = " + mScrubberLeft);
