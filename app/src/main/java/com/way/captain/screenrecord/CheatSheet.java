...
public final class CheatSheet {
     ...
     * {@link View.OnLongClickListener}. When the view is long-pressed, a
     * {@link Toast} with the view's {@link View#getContentDescription() content
     * description} will be shown either above (default) or below the view (if
     ...
     * Sets up a cheat sheet (tooltip) for the given view by setting its
     * {@link View.OnLongClickListener}. When the view is long-pressed, a
     * {@link Toast} with the given text will be shown either above (default) or
     * below the view (if there isn't room above it).
     *
     * @param view      The view to add a cheat sheet for.
