...
import com.way.captain.fragment.GuideFragment;
        ...
        public void transformPage(View page, float position) {
            ...
            if (position <= -1.0f || position >= 1.0f) {
                ...
                if (welcomeImage02 != null) {
                    welcomeImage02.setTranslationX(pageWidth / 2 * position);
                    welcomeImage02.setAlpha(1.0f - Math.abs(position));
                }

                if (welcomeImage03 != null) {
                    welcomeImage03.setTranslationX(pageWidth / 2 * position);
                    welcomeImage03.setAlpha(1.0f - Math.abs(position));
                }
            }
        }
    }
