...
package com.way.capture.widget.floatview;
...
public class FloatingView extends FrameLayout implements ViewTreeObserver.OnPreDrawListener {
    ...
    public boolean onPreDraw() {
        ...
        if (mIsMoveToEdge) {
            ...
            mParams.x = mMetrics.widthPixels;
            mParams.y = (mMetrics.heightPixels) / 2;
     ...
     * アニメーションの制御を行うハンドラです。
     */
    private static class FloatingAnimationHandler extends Handler {
